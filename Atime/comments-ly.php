<?php
/**
 * The template for displaying comments 留言
 *
 * @package ATIME
 * @version 1.0
 */
...
<?php paginate_comments_links('prev_text=上一页&next_text=下一页');?>
	...
	<?php 
		$fields =  array(
   			 ...
   			 'url'  => '<div class="comment-form-url form-group has-feedback"><div class="input-group"><div class="input-group-addon"><i class="fa fa-link"></i></div><input class="form-control" placeholder="您的个人站(可留空)" id="url" name="url" type="text" value="' . esc_attr(  $commenter['comment_author_url'] ) . '" size="30" /></div></div>',
		);
		$args = array(
