...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => '页面背景',
		'id' => 'start_image',
		'std' => get_template_directory_uri() . '/images/start.jpg',
		'type' => 'upload');	
	$options[] = array(
		'name' => '404页面',
		'type' => 'heading');
	...
	$options[] = array(
		...
		'desc' => '自我介绍',
		'id' => 'about_me_welcome',
		'std' => '我是ATIME，电子信息专业学生，在天津工业大学读研究生，个人站点用于分享自己的学习经历，谢谢关注。',
		'type' => 'text');
	$options[] = array(
		'name' => '.02经历段1',
		'desc' => '经历第一段落内容',
		'id' => 'about_me_experience1',
		'std' => '本科就读于北华航天工业学院，主要学习单片机、嵌入式方向。在校期间接触学习51单片机、AVR单片机、MSP430单片机、STM32单片机、S3C2440嵌入式处理器等。',
		'type' => 'text');
	$options[] = array(
		'name' => '.02经历段2',
		'desc' => '经历第二段落内容',
		'id' => 'about_me_experience2',
		'std' => '本科毕业设计完成一个基于FPGA的数据采集器，通过FPGA快速读取ADC转换结果传输显示到PC端。',
		'type' => 'text');
	$options[] = array(
		'name' => '经历配图1',
		'desc' => '左上图',
		'std' => get_template_directory_uri() . '/images/tm-img-1.jpg',
		'id' => 'about_me_experience_pic1',
		'type' => 'upload');
	$options[] = array(
		'name' => '经历配图2',
		'desc' => '右上图',
		'std' => get_template_directory_uri() . '/images/tm-img-2.jpg',
		'id' => 'about_me_experience_pic2',
		'type' => 'upload');
	$options[] = array(
		'name' => '经历配图3',
		'desc' => '左下图',
		'std' => get_template_directory_uri() . '/images/tm-img-3.jpg',
		'id' => 'about_me_experience_pic3',
		'type' => 'upload');
	$options[] = array(
		'name' => '经历配图4',
		'desc' => '右下图',
		'std' => get_template_directory_uri() . '/images/tm-img-4.jpg',
		'id' => 'about_me_experience_pic4',
		'type' => 'upload');
	$options[] = array(
		'name' => '.03Code段落1',
		'desc' => 'Code位置段落1',
		'id' => 'about_me_code1',
		'std' => 'ATIME_51MCU:是适用于51单片机的基础函数库，本函数库提供对51单片机外设的封装函数，使得功能实现简洁高效。',
		'type' => 'text');
	$options[] = array(
		'name' => '.03Code段落2',
		'desc' => 'Code位置段落2',
		'id' => 'about_me_code2',
		'std' => 'ATIME_MSP430:该函数库将MSP430的外设封装成标准函数，大部分模块采用“器件名_init”函数初始化，以“器件名_read/_write”函数操作，函数命名规则统一，使用方便。',
		'type' => 'text');
	$options[] = array(
		'name' => '.03Code段落3',
		'desc' => 'Code位置段落3',
		'id' => 'about_me_code3',
		'std' => 'S3C2440:是我在学习嵌入式过程中编写的一部分代码仓库，学习路线从裸机程序到bootloader，目前还在学习中。',
		'type' => 'text');
	$options[] = array(
		'name' => '.04Contact内容',
		'desc' => 'Contact内容',
		'id' => 'about_me_contact',
		'std' => '欢迎大家关注我的微信公众号获取最新资讯，欢迎email交流~',
		'type' => 'text');
	$options[] = array(
		'name' => '.04Contact Email',
		'desc' => 'email',
		'id' => 'about_me_email',
		'std' => 'atime@atime.net.cn',
		'type' => 'text');
	$options[] = array(
		'name' => '.04Contact Wechat',
		'desc' => '微信',
		'id' => 'about_me_wechat',
		'std' => 'ATIME的嵌入式学习笔记',
		'type' => 'text');
