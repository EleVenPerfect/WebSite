...
$kratos_update_checker = new ThemeUpdateChecker(
    'Atime', 
    'https://www.atime.net.cn/Vtrois/Kratos/master/inc/upgrade.json'
);
...
function Kratos_admin_notice() {
  ...
  <p class="about-description">嗨，欢迎使用 ATIME 主题开始创作，同时欢迎您加入主题交流群：<a target="_blank" rel="nofollow" href="https://jq.qq.com/?_wv=1027&k=5FgWFax">316620972</a></p>
  </div>
  <?php
}
...
function kratos_admin_footer_text($text) {
       $text = '<span id="footer-thankyou">感谢使用 <a href=http://cn.wordpress.org/ target="_blank">WordPress</a>进行创作，<a target="_blank" rel="nofollow" href="https://jq.qq.com/?_wv=1027&k=5FgWFax">点击</a> 加入主题讨论群。</span>';
    return $text;
}
