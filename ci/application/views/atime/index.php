...
<link rel="icon" href="<?php echo base_url("file/atime/"); ?>/images/favicon.ico">
<link rel="shortcut icon" href="<?php echo base_url("file/atime/"); ?>/images/favicon.ico" />
<link rel="stylesheet" href="<?php echo base_url("file/atime/"); ?>/css/style.css">
<script src="<?php echo base_url("file/atime/"); ?>/js/jquery.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/jquery-migrate-1.1.1.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/jquery.easing.1.3.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/script.js"></script> 
<script src="<?php echo base_url("file/atime/"); ?>/js/superfish.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/jquery.equalheights.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/jquery.mobilemenu.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/tmStickUp.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/jquery.ui.totop.js"></script>
<script src="<?php echo base_url("file/atime/"); ?>/js/jquery.shuffle-images.js"></script>
<script>
