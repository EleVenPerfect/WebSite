...
<head>
		...
		<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/jscex-parser.js"></script>
		<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/jscex-jit.js"></script>
		<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/jscex-builderbase.js"></script>
		<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/jscex-async.js"></script>
		<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/jscex-async-powerpack.js"></script>
		<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/functions.js" charset="utf-8"></script>
		<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/love.js" charset="utf-8"></script>
		<script type="text/javascript" async="" src="<?php echo base_url()?>bootstrap/kk/embed.js" charset="UTF-8"></script>
		<link type="text/css" rel="stylesheet" href="<?php echo base_url()?>bootstrap/kk/embed.default.css">
		<style type="text/css">#ds-thread .ds-powered-by{display:none!important;}</style>
</head>
<body>
	<audio autoplay="autopaly">
		<source src="http://mpge.5nd.com/2010/2010b/2011-10-11/49970/1.mp3" type="audio/mp3">
	</audio>
       <div id="main">
	...
	<link type="text/css" rel="stylesheet" href="<?php echo base_url()?>bootstrap/kk/kk.css">
	<script type="text/javascript" src="<?php echo base_url()?>bootstrap/kk/kk.js" charset="utf-8"></script>
</html>