...
<head>
<title><?php echo $webname ?>-英国免费PHP空间 - sinsy.com.cn</title>
  ...
  <div class="header_panel">
    <div class="header_panel_resize">
      <div class="bloga">
        ...
        <p>点击马上注册填写表格完成免费主机注册，系统将自动为你分配一个“用户名.<?php echo $yourdomain ?>”的域名测试访问。</p>
      ...
      <div class="bloga">
        ...
        <p><a href="http://cpanel.<?php echo $yourdomain ?>" class="btn-small">点击登陆</a></p>
      </div>
    </div>
    <div class="spacer"></div>
  </div>
