...
if($the_host !== 'www.atime.host')//如果域名不是带www的网址那么进行下面的301跳转
{
header('HTTP/1.1 301 Moved Permanently');//发出301头部 
header('Location:http://www.atime.host'.$the_url);//跳转到带www的网址
}
?>
  ...
  <div class="header_panel">
    <div class="header_panel_resize">
      <div class="bloga">
        ...
        <p>点击马上注册填写表格完成免费主机注册，系统将自动为你分配一个“用户名.atime.host”的域名测试访问。</p>
      ...
      <div class="bloga">
        ...
        <p><a href="http://cpanel.atime.host" class="btn-small">点击登陆</a></p>
      </div>
    </div>
    <div class="spacer"></div>
  </div>
